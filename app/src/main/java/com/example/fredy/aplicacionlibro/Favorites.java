...
public class Favorites extends SQLiteOpenHelper {
    ...
    String sqlCreate = "CREATE TABLE Favoritos (identificacion INTEGER, urlImagen TEXT, idImageShare)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        if (i1 > i) {
            ...
            sqLiteDatabase.execSQL("ALTER TABLE " + "Favoritos" + " ADD COLUMN " + "idImageShare" + " TEXT");
